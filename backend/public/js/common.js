    ...
    btn.addEventListener("click", async () => {
        try {
            ...
            if (!token) {
                ...
                window.location.href = "/admin"; // Updated to relative path
                return;
            }
            ...
            const res = await fetch("/submit-report", { // Updated to relative path
                method: "POST",
                headers: {
            ...
            if (res.ok && data.fileId) {
                ...
                window.open("/get-pdf/" + data.fileId, "_blank"); // Updated to relative path
            } else {
...
async function emailReport() {
    ...
    alert("Please save the report first to generate the PDF, then go to the dashboard to email it.");
}
